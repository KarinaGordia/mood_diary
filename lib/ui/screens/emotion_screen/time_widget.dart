...
class _TimeWidgetState extends State<TimeWidget> {
  ...
  late CalendarScreenViewModel _calendarScreenViewModel;
    ...
    return Row(
      ...
      children: [
        ...
        IconButton(
          ...
          onPressed: () {
            _calendarScreenViewModel = CalendarScreenViewModel();
            model.showCalendar(context, _calendarScreenViewModel);
            },
